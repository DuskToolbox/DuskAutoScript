...
ASR_INTERFACE IAsrComponentFactory;
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrComponent, IAsrBase, IAsrTypeInfo);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrJson, IAsrBase);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrSwigComponent, IAsrSwigBase, IAsrSwigTypeInfo);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrSwigVariantVector, IAsrSwigBase);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrVariantVector, IAsrBase);
