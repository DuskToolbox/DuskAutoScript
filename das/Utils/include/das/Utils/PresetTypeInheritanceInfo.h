...
DAS_INTERFACE IDasJsonSetting;
DAS_INTERFACE IDasJsonSettingOnDeletedHandler;
DAS_INTERFACE IDasJsonSettingOperator;
...
DAS_INTERFACE IDasSwigPluginPackage;
...
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasJsonSetting, IDasBase);
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasJsonSettingOnDeletedHandler, IDasBase);
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasJsonSettingOperator, IDasBase);
...
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasPluginPackage, IDasBase);
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasProfile, IDasBase);
...
DAS_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IDasSwigPluginPackage, IDasSwigBase);
