...
private:
    ...
    DAS::DasPtr<IDasPluginManager> p_plugin_manager{};

    std::shared_ptr<ObjectMapper> jsonObjectMapper{
        oatpp::parser::json::mapping::ObjectMapper::createShared()};

    static auto CreatePluginManager() -> DAS::DasPtr<IDasPluginManager>
    {
        DAS::DasPtr<IDasPluginManager> result{};
        ...
        const auto error_code = ::CreateIDasPluginManagerAndGetResult(
            p_const_empty_guids.Get(),
            result.Put());

        const auto create_message = DAS_FMT_NS::format(
            "CreateIDasPluginManagerAndGetResult return {}.",
            error_code);
...
public:
    ...
    {
        ::CreateIDasLogRequester(32, p_requester.Put());
        // TODO:
...
//             DasMakeDasGuid("6C78DCAD-9173-4EE3-84CC-546973658460", &touch_iid);
//         DAS::DasPtr<IDasTask> p_task{};
//         p_plugin_manager->FindInterface(touch_iid, p_task.PutVoid());
//         DAS::DasPtr<IDasReadOnlyString> p_profile{};
