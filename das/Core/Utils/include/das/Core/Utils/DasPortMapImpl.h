...
public:
    ...
    DAS_IMPL
    GetType(IDasReadOnlyString* p_port_id, DasVariantType* out_kind) override;
    ...
    GetJson(IDasReadOnlyString* p_port_id, IDasReadOnlyString** pp_out_json)
        override;
    DAS_IMPL
    GetImage(IDasReadOnlyString* p_port_id, IDasImage** pp_out_image) override;
    DAS_IMPL
    GetBase(
    ...
    DAS_IMPL GetKeys(IDasStringVector** pp_out_keys) override;
    ...
    DAS_IMPL
    SetImage(IDasReadOnlyString* p_port_id, IDasImage* p_image) override;
    DAS_IMPL
    SetBase(IDasReadOnlyString* p_port_id, DasGuid iid, IDasBase* p_object)
        override;
    DAS_IMPL
    SetComponent(
        IDasReadOnlyString* p_port_id,
        DasGuid             iid,
        IDasBase*           p_component) override;
