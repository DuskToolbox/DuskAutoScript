...
namespace Das::Core::IPC::Test
{
    ...
    TEST(IpcMessageHeaderV3Test, MagicValue)
    {
        ...
        // In little-endian: 0x43504944 = 'D'(0x44) 'I'(0x49) 'P'(0x50)
        // 'C'(0x43)
    ...
    {
        auto validated =
            IPCMessageHeaderBuilder().SetSourceSessionId(0x1234).Build();
    ...
    {
        auto validated =
            IPCMessageHeaderBuilder().SetTargetSessionId(0x5678).Build();
    ...
    TEST(IpcMessageHeaderV3Test, BuilderSetCallIdUint16)
    {
        ...
        auto validated = IPCMessageHeaderBuilder().SetCallId(0xFFFF).Build();
    ...
    TEST(IpcMessageHeaderV3Test, BuilderSetInterfaceId)
    {
        ...
        auto validated =
            IPCMessageHeaderBuilder().SetInterfaceId(0x12345678).Build();
