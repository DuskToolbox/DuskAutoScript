...
public:
    ...
    DasResult WriteInt8(int8_t value) { return Write(&value, sizeof(value)); }

    DasResult WriteUInt8(uint8_t value) { return Write(&value, sizeof(value)); }

    DasResult WriteInt16(int16_t value) { return Write(&value, sizeof(value)); }
    ...
    DasResult WriteInt32(int32_t value) { return Write(&value, sizeof(value)); }
    ...
    DasResult WriteInt64(int64_t value) { return Write(&value, sizeof(value)); }
    ...
    DasResult WriteFloat(float value) { return Write(&value, sizeof(value)); }

    DasResult WriteDouble(double value) { return Write(&value, sizeof(value)); }
...
public:
    ...
    DasResult ReadInt8(int8_t* value) { return Read(value, sizeof(*value)); }

    DasResult ReadUInt8(uint8_t* value) { return Read(value, sizeof(*value)); }

    DasResult ReadInt16(int16_t* value) { return Read(value, sizeof(*value)); }
    ...
    DasResult ReadInt32(int32_t* value) { return Read(value, sizeof(*value)); }
    ...
    DasResult ReadInt64(int64_t* value) { return Read(value, sizeof(*value)); }
    ...
    DasResult ReadFloat(float* value) { return Read(value, sizeof(*value)); }

    DasResult ReadDouble(double* value) { return Read(value, sizeof(*value)); }
    ...
    DasResult ReadString(std::string& str)
    {
        ...
        if (result == DAS_S_OK)
        {
            str.assign(reinterpret_cast<char*>(buffer.data()), buffer.size());
        }
        return result;
    }
