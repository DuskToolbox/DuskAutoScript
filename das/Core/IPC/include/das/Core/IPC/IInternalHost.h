#ifndef DAS_CORE_IPC_I_INTERNAL_HOST_H
#define DAS_CORE_IPC_I_INTERNAL_HOST_H
...
class IInternalHost : public IDasBase
{
public:
...
protected:
    IInternalHost() = default;
    virtual ~IInternalHost() = default;
};

DAS_CORE_IPC_NS_END

#endif // DAS_CORE_IPC_I_INTERNAL_HOST_H
